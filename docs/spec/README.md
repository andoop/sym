# Language specification index / 语言规范索引

**English:** These documents are written primarily in **Chinese**. They track design intent and the current implementation; when in doubt, **source code** (`crates/symc`) wins.

| Document | Description (EN) | 说明（中文） |
|----------|------------------|-------------|
| [LANGUAGE.md](LANGUAGE.md) | Language sketch | 语言规范大纲 |
